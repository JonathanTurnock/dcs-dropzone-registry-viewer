...
export const getGetRegistryIndexKey = () =>
  [`https://dcs-mod-manager-registry.pages.dev/index.json`] as const;
...
export const useGetRegistryIndex = <TError = AxiosError<unknown>>(options?: {
  ...
  const swrKey =
    swrOptions?.swrKey ?? (() => (isEnabled ? getGetRegistryIndexKey() : null));
...
export const getRegistryEntry = (
  ...
  return axios.default.get(
    `https://dcs-mod-manager-registry.pages.dev/${id}/index.json`,
    options,
  );
};

export const getGetRegistryEntryKey = (id: string) =>
  [`https://dcs-mod-manager-registry.pages.dev/${id}/index.json`] as const;
...
export const useGetRegistryEntry = <TError = AxiosError<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getGetRegistryEntryKey(id) : null));
